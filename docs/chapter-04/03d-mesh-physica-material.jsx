...
export function Scene() {
    ...
    useEffect(()=>{
        ...
        var meshMaterial = new THREE.MeshPhysicalMaterial({color: 0x7777ff});
        ...
        spGui.add(controls, 'reflectivity', 0, 1).onChange(function (e) {
            meshMaterial.reflectivity= e
        });

        spGui.add(controls, 'clearcoat', 0, 1).onChange(function (e) {
            meshMaterial.clearcoat= e
        });

        spGui.add(controls, 'clearcoatRoughness', 0, 1).onChange(function (e) {
